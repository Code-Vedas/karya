...
1. [Create an issue](https://github.com/Code-Vedas/karya/issues/new/choose) in the repository.
...
To release a new version of the `karya` gem, follow these steps.

Pick the version number from draft release notes on the
[releases page](https://github.com/Code-Vedas/karya/releases).
...
10. **Create a GitHub Release**
    ...
    [GitHub releases page](https://github.com/Code-Vedas/karya/releases).
