...
RSpec.describe 'Karya::QueueStore::Internal::ReferenceQueueStore::Internal::WorkflowChildState' do
  subject(:workflow_child_state) { described_class.new(state: store_state, now: captured_at) }

  let(:described_class) do
    Karya::QueueStore::Internal::ReferenceQueueStore.const_get(:Internal, false).const_get(:WorkflowChildState, false)
  end
  let(:store_state) do
