...
RSpec.describe 'Karya::QueueStore::Internal::ReferenceQueueStore::Internal::ExecutionRecovery' do
  let(:described_class) do
    Karya::QueueStore::Internal::ReferenceQueueStore.const_get(:Internal, false).const_get(:ExecutionRecovery, false)
  end
