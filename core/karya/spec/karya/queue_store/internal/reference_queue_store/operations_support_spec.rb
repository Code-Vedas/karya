...
RSpec.describe 'Karya::QueueStore::Internal::ReferenceQueueStore::Internal::OperationsSupport' do
  let(:internal) { Karya::QueueStore::Internal::ReferenceQueueStore.const_get(:Internal, false).const_get(:OperationsSupport, false) }
