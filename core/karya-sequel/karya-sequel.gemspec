...
version = File.read(File.expand_path('lib/karya/sequel/version.rb', __dir__))
              .match(/VERSION\s*=\s*['"]([^'"]+)['"]/)[1]

Gem::Specification.new do |spec|
  spec.name = 'karya-sequel'
  spec.version = version
  spec.authors = ['Nitesh Purohit', 'Codevedas Inc.']
  spec.email = ['nitesh.purohit.it@gmail.com', 'team@codevedas.com']
  spec.summary = 'Sequel adapter support for Karya.'
  spec.description = <<~DESC
    Karya-Sequel provides the Sequel adapter surface for Karya, including
    adapter key selection and connection-mode helpers for SQL deployments built
    on Sequel.
  DESC
  ...
  spec.metadata['rubygems_uri'] = 'https://rubygems.org/gems/karya-sequel'
