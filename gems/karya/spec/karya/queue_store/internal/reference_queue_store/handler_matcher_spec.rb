...
require_relative '../../../../../lib/karya/queue_store/internal/reference_queue_store/handler_matcher'

RSpec.describe 'Karya::QueueStore::Internal::ReferenceQueueStore::Internal::HandlerMatcher' do
  let(:described_class) do
    Karya::QueueStore::Internal::ReferenceQueueStore.const_get(:Internal, false).const_get(:HandlerMatcher, false)
  end
  ...
  it 'normalizes and sorts explicit handler names for subscription keys' do
    ...
    expect(matcher.handler_names_for_query).to eq(%w[email_sync billing_sync])
  end
