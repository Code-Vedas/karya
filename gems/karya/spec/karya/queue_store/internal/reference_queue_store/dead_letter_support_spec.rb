...
RSpec.describe 'Karya::QueueStore::Internal::ReferenceQueueStore::Internal::DeadLetterSupport' do
  let(:internal) { Karya::QueueStore::Internal::ReferenceQueueStore.const_get(:Internal, false).const_get(:DeadLetterSupport, false) }
