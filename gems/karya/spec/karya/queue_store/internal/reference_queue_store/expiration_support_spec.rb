...
RSpec.describe 'Karya::QueueStore::Internal::ReferenceQueueStore::Internal::ExpirationSupport' do
  subject(:store) { store_class.new }

  let(:store_class) { Karya::QueueStore::InMemory }
  let(:internal) { Karya::QueueStore::Internal::ReferenceQueueStore.const_get(:Internal, false) }
  let(:expiring_job_class) do
    internal.const_get(:ExpirationSupport, false).const_get(:ExpiringJob, false)
  end
