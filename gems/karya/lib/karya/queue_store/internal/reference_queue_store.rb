  ...
  module QueueStore
    module Internal
      ...
      module ReferenceQueueStore
        ...
        DEFAULT_EXPIRED_TOMBSTONE_LIMIT = Karya::Internal::DurableQueueStore::SharedSupport::DEFAULT_EXPIRED_TOMBSTONE_LIMIT
        DEFAULT_COMPLETED_BATCH_RETENTION_LIMIT =
          Karya::Internal::DurableQueueStore::SharedSupport::DEFAULT_COMPLETED_BATCH_RETENTION_LIMIT
        DEFAULT_MAX_BATCH_SIZE = Karya::Internal::DurableQueueStore::SharedSupport::DEFAULT_MAX_BATCH_SIZE
        RESERVE_QUEUES_ERROR_MESSAGE = Karya::Internal::DurableQueueStore::SharedSupport::RESERVE_QUEUES_ERROR_MESSAGE
        ...
        def durable_reserve_candidate_job_ids_for_queue(**_query)
          nil
        end
