        ...
        module Internal
          ...
          module RequestSupport
            ...
            def normalize_reserve_queues(queue:, queues:)
              ...
              raise InvalidQueueStoreOperationError, ValidationSupport::RESERVE_QUEUES_ERROR_MESSAGE unless reserve_queues
            ...
            def reservation_token_in_use?(reservation_token) = state.reservation_token_in_use?(reservation_token)
          end
        end
      end
    end
