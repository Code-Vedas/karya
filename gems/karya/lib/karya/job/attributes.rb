  ...
  class Job
    ...
    class Attributes
      ...
      def normalized_attributes(created_at:, lifecycle:, attempt:, priority:)
        normalized_enqueued_at = normalize_enqueued_at(created_at)
      ...
      def normalize_enqueued_at(created_at)
        TimestampNormalizer.new(:enqueued_at, optional(:enqueued_at, created_at)).normalize
      end
