...
require_relative 'primitives/forker'
require_relative 'primitives/optional_callable'
require_relative 'primitives/outbound_event_dispatcher'
require_relative 'primitives/optional_outbound_event_dispatcher'
...
module Karya
  ...
  class WorkerSupervisor
    ...
    def prepare_queue_store_for_fork
      return unless queue_store.respond_to?(:disconnect_for_fork, true)

      queue_store.send(:disconnect_for_fork)
    end
